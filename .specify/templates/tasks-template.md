...
**Tests**: The examples below include test tasks. Tests are MANDATORY — TDD is non-negotiable per the project constitution. Test tasks MUST be written before the implementation tasks they cover.
